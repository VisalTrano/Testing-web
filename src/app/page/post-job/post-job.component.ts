...
export class PostJobComponent implements OnInit {
    ...
    getJobCategory() {
        this.jobService.jobCategory().subscribe((data: any) => {
            this.jobCategory = data;
        });
    }

    getCareerLevel() {
        this.jobService.careerLevel().subscribe((data: any) => {
            this.careerLevel = data;
        });
    }

    getQualification() {
        this.jobService.qualification().subscribe((data: any) => {
            this.qualification = data;
        });
    }

    getIndustry() {
        this.jobService.industry().subscribe((data: any) => {
            this.industry = data;
        });
    }
